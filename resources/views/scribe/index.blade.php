...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://api-physiomobile.test";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-tokens-create">POST api/tokens/create</a>
                            </li>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-tokens-create">POST api/tokens/create</h2>
...
<div class="bash-example">
    ...
    "http://api-physiomobile.test/api/tokens/create" \
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-tokens-create"
               value="architecto"
               data-component="body">
    <br>
...
<div class="bash-example">
    ...
    --get "http://api-physiomobile.test/api/patients" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://api-physiomobile.test/api/patients"
);

const headers = {
    "accessKey": "string required value api/tokens/create",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="accessKey"                data-endpoint="GETapi-patients"
               value="string required value api/tokens/create"
               data-component="header">
    <br>
<p>Example: <code>string required value api/tokens/create</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://api-physiomobile.test/api/patients/architecto" \
    --header "accessKey: string required value api/tokens/create" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://api-physiomobile.test/api/patients/architecto"
);
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="accessKey"                data-endpoint="GETapi-patients--patientId-"
               value="string required value api/tokens/create"
               data-component="header">
    <br>
<p>Example: <code>string required value api/tokens/create</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="accessKey"                data-endpoint="POSTapi-patients"
               value="string required value api/tokens/create"
               data-component="header">
    <br>
<p>Example: <code>string required value api/tokens/create</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="accessKey"                data-endpoint="PUTapi-patients--patientId-"
               value="string required value api/tokens/create"
               data-component="header">
    <br>
<p>Example: <code>string required value api/tokens/create</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="accessKey"                data-endpoint="DELETEapi-patients--id-"
               value="string required value api/tokens/create"
               data-component="header">
    <br>
<p>Example: <code>string required value api/tokens/create</code></p>
